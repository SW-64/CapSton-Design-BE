...
CREATE TABLE `spots` (
    ...
    `district_districtId` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `spots` ADD CONSTRAINT `spots_district_districtId_fkey` FOREIGN KEY (`district_districtId`) REFERENCES `districts`(`districtId`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `districts` ADD CONSTRAINT `districts_city_cityId_fkey` FOREIGN KEY (`city_cityId`) REFERENCES `citys`(`cityId`) ON DELETE RESTRICT ON UPDATE CASCADE;
